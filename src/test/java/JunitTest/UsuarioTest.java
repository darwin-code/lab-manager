...
public class UsuarioTest {
    ...
    public void testAgregarInfo() {
        ...
        JDateChooser dia = new JDateChooser(); // Fecha actual
        JTextField nombre = new JTextField("Selena");
        JComboBox genero = new JComboBox();
        genero.addItem("Femenino");
        JTextField materia = new JTextField("ASO");
        JTextField alumnos = new JTextField("9");
        JTextArea observacion = new JTextArea("Clase de repaso para el examen final");
